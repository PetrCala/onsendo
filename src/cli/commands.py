...
COMMANDS = {
    ...
    "add-visit": CommandConfig(
        ...
        args={
            ...
            "main_bath_temperature": ArgumentConfig(type=int, default=0),
            ...
            "sauna_temperature": ArgumentConfig(type=int, default=0),
            "sauna_duration_minutes": ArgumentConfig(type=int, default=0),
            "sauna_rating": ArgumentConfig(type=int, default=0),
            "outdoor_bath_temperature": ArgumentConfig(type=int, default=0),
