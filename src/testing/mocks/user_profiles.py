...
class UserProfile:
    ...
    rating_correlations: dict[
        str, float
    ]  # Which factors most influence personal rating
    ...
    def generate_personal_rating(
        ...
        **kwargs,
        ...
        # Combine all effects
        final_score = (
            base_score + price_effect + crowd_effect + weather_effect + self.rating_bias
        )
...
PROFILE_MAP = {
    profile.name.lower().replace(" ", "_"): profile for profile in ALL_PROFILES
}
