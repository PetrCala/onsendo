...
ANALYSIS_SCENARIOS: dict[AnalysisScenario, AnalysisScenarioConfig] = {
    ...
    # Professional econometric scenarios
    AnalysisScenario.ENJOYMENT_DRIVERS: AnalysisScenarioConfig(
        name=AnalysisScenario.ENJOYMENT_DRIVERS,
        description="Econometric analysis of factors driving personal enjoyment ratings",
        analysis_types=[AnalysisType.ECONOMETRIC, AnalysisType.REGRESSION],
        data_categories=[
            DataCategory.VISIT_RATINGS,
    ...
    AnalysisScenario.PRICING_OPTIMIZATION: AnalysisScenarioConfig(
        ...
        analysis_types=[AnalysisType.ECONOMETRIC, AnalysisType.COMPARATIVE],
        data_categories=[
            DataCategory.VISIT_RATINGS,
            DataCategory.VISIT_LOGISTICS,
            DataCategory.ONSEN_FEATURES,
